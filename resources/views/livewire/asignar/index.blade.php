<main class="content-body">
    <div class="d-flex justify-content-between mb-2">
        <h2 class="content-header-title float-start mb-0 text-dark">Asignar Jefes de Departamentos</h2>
        @if ($cantAsignada == 4)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button type="button"
                                        ...
                                        wire:click="$emit('confirmDelete',{{ $c->id_col_dep }})"
    ...
    <!-- Accordion end -->
    @if ($_create)
        @include('livewire.asignar.create')
    @endif
    @if ($_edit)
        @include('livewire.asignar.edit')
    @endif

    @push('js')
        <script>
            var isRtl = $('html').attr('data-textdirection') === 'rtl'
            const url = 'asignar-colaboradores';
