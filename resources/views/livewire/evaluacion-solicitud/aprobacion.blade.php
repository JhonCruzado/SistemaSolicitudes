        ...
        <table cellpadding="0" cellspacing="0" border="1"
            ...
            <tr>
                ...
                <table style="font-size: 14px; border-spacing: inherit;">
                    <tbody>
                    <tr>
                        <td style="color: #0d6efd;text-align: center;font-size: 20px; padding: 2rem">
                    ...
                    <tr>
                        <td style="text-align: center; padding: 1rem 0; border: none; font-size: 14px;">
                            <button type="submit" style="text-decoration: none; background: #0d6efd; padding: .7rem 1.2rem; color: #fff; border-radius: 20px;margin-right:10px" class="btn btn-primary">Aprobar
                            solicitud</button>
                        </td>
                    </tr>
                    </tbody>
